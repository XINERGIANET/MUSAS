...
class TransformationsReportController extends Controller
{
    /**
     ...
     */
     ...
     public function index(Request $request)
     {
         ...
         $movementsQuery = Movement::with(['movementDetails.product', 'headquarter']);
     
         $movementsQuery->where('tipo', 1);
         ...
         return view('transformations_report.index', compact('products', 'movements'));
     }
