...
class Storage2Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Producto Industrializado creado exitosamente',
                'product' => $product
            ]);
        } catch (\Exception $e) {
            // Manejar errores
            return response()->json([
                'success' => false,
                'message' => 'Error al crear el producto Industrializado: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            if ($wasModified) {
                ...
                return redirect()->route('storage2.index')
