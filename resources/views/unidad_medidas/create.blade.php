...
<p>Complete el formulario para registrar una nueva unidad de medida.</p>
@endsection
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="header-title w-100">
                        ...
                        <form id="createUnidadMedidasForm" action="{{ route('unidad_medidas.store') }}" method="POST">
                            @csrf
                            <div class="mb-3 row">
...
<script>
    ...
    const form = document.getElementById('createUnidadMedidasForm');
