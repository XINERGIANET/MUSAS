                    ...
                    <form action="" class="mt-3" id="fromFilter">
                        <div class="row d-flex">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <div class="mb-3 w-50s me-2">
                                        <a href="{{ route('transfers_report.index') }}" class="btn btn-warning w-100" id="btnLimpiar">Limpiar</a>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-striped" id="purchaseTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if (!$user->hasRole('adminSede'))
                                        <td>{{ $movement->headquarter ? $movement->headquarter->nombre : 'Sin origen' }}</td>
                                        @endif

                                        <td>{{ $movement->headquarter_to ? $movement->headquarter_to->nombre : 'Sin destino' }}</td>
                                        <td>{{ $movement->date }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
