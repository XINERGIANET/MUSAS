    ...
    <table class="resumen-table">
        <thead>
            <tr>
                ...
                <th style="width: 15%; text-align: center;">Stock Final (S/)</th>
        ...
        <tbody>
            @foreach($stock as $item)
                <tr>
                    @php
                    $precio = $item->unit_price ?? $item->precio_actual;
                    @endphp
                    <td>{{ $item->product->nombre }}</td>
                    <td style="text-align: center;">{{ $item->stock_final }}</td>
                    <td style="text-align: center;"><b>{{ number_format($item->stock_final * $precio, 2) }}</b></td>
                    <td class="text-align: center;">{{ $item->fecha->format('d/m/Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
