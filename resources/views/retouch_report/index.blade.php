...
@section('header')
<h2>Reporte de retoques</h2>
<p>Listado de retoques</p>
@endsection
                    ...
                    <form action="" class="mt-3" id="fromFilter">
                        <div class="row d-flex">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <div class="mb-3 w-50s me-2">
                                        <a href="{{ route('retouch_report.index') }}" class="btn btn-warning w-100" id="btnLimpiar">Limpiar</a>
                                </div>
                            </div>

                            <div class="col-md-3 d-flex align-items-end">
                                <a href="{{ route('retouchReport.pdf',
                                    [
...
<script>
    ...
    document.getElementById('clearForm').addEventListener('click', function () {
        ...
        document.getElementById('createRetouchForm').submit();
    });
