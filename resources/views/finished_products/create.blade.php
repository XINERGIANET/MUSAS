...
@section('header')
<h2>Registrar Productos Industrializado</h2>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="header-title w-100">
                        ...
                        <form id="createFinishedProductForm" action="{{ route('finished_products.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3 row">
                                ...
                                {{-- <label for="observacion" class="col-sm-3 col-form-label text-start">Categoría</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control border-dark" id="observacion" name="observacion" required>
                                </div> --}}
...
<script>
		...
		$.ajax({
			...
			success: function(data){
				if(data.status){
					...
					ToastMessage.fire({ text: 'Archivo importado' })
    ...
    $('#createFinishedProductForm').on('submit', function(e) {
        e.preventDefault();
