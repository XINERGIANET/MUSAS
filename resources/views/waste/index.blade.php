...
<p>Complete el formulario para registrar una nueva merma</p>
@endsection
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="header-title w-100">
            ...
            <form id="createWasteForm" action="{{ route('waste.store') }}" method="POST">
              @csrf
            ...
            <hr>
            <form method="GET" action="{{ route('waste.index') }}" class="mb-4">
              <div class="row">
  ...
  $('#search-product').autocomplete({
    source: function(request, response) {
      var results = $.map(products, function(item) {
        // Filtrar por nombre Y por category_id (2 o 3)
        if (
