...
<head>
    ...
    <title>Resumen de Producciones</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h2>Resumen de Producciones por Producto</h2>
    ...
    <div class="filter-info">
        ...
        @if($filterInfo['sede'] || $filterInfo['turno'])
        <div class="filter-row">
            ...
            @if($filterInfo['turno'] !== null)
            <div class="filter-item">
                <span class="filter-label">Turno:</span>
                <span class="filter-value">{{ $filterInfo['turno'] == 0 ? 'Mañana' : 'Tarde' }}</span>
            </div>
            @endif
        </div>
        @endif
