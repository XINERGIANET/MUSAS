        ...
        @foreach($purchases as $index => $purchase)
            <div class="purchase-block">
                ...
                <div class="purchase-header">
                    ...
                    @if($purchase->tipo_comprobante && $purchase->invoice_number)
                        | {{ strtoupper($purchase->tipo_comprobante) }}: {{ $purchase->invoice_number ?? '---' }}
                    @endif
                </div>
                
                <!-- Información del proveedor -->
                <div class="supplier-info">
                    <strong>PROVEEDOR:</strong> {{ $purchase->supplier->razon_social ?? 'Sin proveedor' }}
                ...
                <div class="purchase-total">
                    TOTAL {{ strtoupper($tipo === 'egreso' ? 'EGRESO' : 'COMPRA') }}: S/ {{ number_format($purchase->details->sum('subtotal'), 2) }}
                </div>
            </div>
        @endforeach
