                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 class="counter">S/. {{ number_format($totalVentas, 2, '.', ',') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                            <div class="card-body">
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        <p class="mb-2">Total Compras</p>
                                        <h4 class="counter">S/. {{ number_format($totalCompras, 2, '.', ',') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                        @php
                        $colores = ['info', 'primary', 'success', 'warning', 'danger', 'dark', 'secondary'];
                        @endphp

                        @foreach ($ventasPorSede as $index => $venta)
                        @php
                        $porcentaje = $totalVentas > 0 ? ($venta['total'] / $totalVentas) * 100 : 0;
                        $color = $colores[$index % count($colores)]; // rotar colores si hay más sedes
                        @endphp
                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="{{ 1000 + ($index * 100) }}">
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-{{ $index }}"
                                        class="text-center circle-progress-01 circle-progress circle-progress-{{ $color }}"
                                        data-min-value="0"
                                        data-max-value="100"
                                        data-value="{{ round($porcentaje, 0) }}"
                                        data-type="percent">
                                    ...
                                    <div class="progress-detail">
                                        <p class="mb-2">{{ $venta['sede'] }}</p>
                                        <h4 class="counter">S/. {{ number_format($venta['total'], 2, '.', ',') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="row">
                    ...
                    <div class="card" data-aos="fade-up" data-aos-delay="800">
                        <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                            <div class="header-title">
                                <h4 class="card-title">S/. {{ number_format($totalCompras, 2, '.', ',') }}</h4>
                                <p class="mb-0">Total de compras</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <div id="de-main" class="de-main">
                                <!-- GRAFICO DE UTILIDAD BRUTA -->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card" data-aos="fade-up" data-aos-delay="800">
                        <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                            <div class="header-title">
                                <h4 class="card-title">S/. {{ number_format($totalVentas, 2, '.', ',') }}</h4>
                                <p class="mb-0">Total de ventas</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <div id="de-sale" class="de-sale">
                                <!-- GRAFICO DE UTILIDAD BRUTA -->
                            </div>
                        </div>
                    </div>
                ...
                <!-- GRAFICO CIRCULAR -->
                @php
                $colores = ['#3a57e8', '#4bc7d2', '#ffc107', '#00e396', '#ff4560', '#775dd0'];
                @endphp
                <div class="col-md-12 col-xl-6">
                    <div class="card" data-aos="fade-up" data-aos-delay="900">
                        ...
                        <div class="card-body">
                            <div id="grafico-medios-pago" style="min-height: 300px;"></div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var options = {
            ...
            colors: ['#3b76ef', '#00cfe8'], // ventas, compras
            dataLabels: {
                enabled: false
            },
            stroke: {
            ...
            tooltip: {
                y: {
                    formatter: function(val) {
                        return 'S/. ' + new Intl.NumberFormat('es-PE').format(val.toFixed(2));
                    }
                }
            }
        };

        var chart = new ApexCharts(document.querySelector("#de-main"), options);
        chart.render();
    });

    // GRAFICO DE TOTAL DE VENTAS
    document.addEventListener("DOMContentLoaded", function() {
        var options = {
            chart: {
                height: 300,
        ...
        var chart = new ApexCharts(document.querySelector("#de-sale"), options);
        chart.render();
    });
    ...
    const options = {
        ...
        labels: @json($mediosPago->pluck('nombre')),
        series: @json($mediosPago->pluck('total')),
        colors: @json(array_slice($colores, 0, $mediosPago->count())),
...
,
    ...
    const chart = new ApexCharts(document.querySelector("#grafico-medios-pago"), options);
    chart.render();
});
</script>
@endsection