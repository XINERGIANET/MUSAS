...
return [
    ...
    */
    ...
    'attributes' => [
        'account_id' => 'cuenta',
        'address' => 'dirección',
        'amount_1' => 'monto efectivo',
        'amount_2' => 'monto tarjeta',
        'amount_3' => 'monto yape',
        'amount' => 'monto',
        'amounts.*' => 'monto',
        'area_id' => 'área',
        ...
        'event_end' => 'hora de fin de evento',
        'file' => 'archivo',
        'files' => 'archivos',
        'files.*' => 'archivo',
        'final_loss' => 'merma final',
        'final_stock' => 'stock final',
        'food_stock' => 'stock comida',
        ...
        'number' => 'número',
        'operation_number_2' => 'número de operación tarjeta',
        'operation_number_3' => 'número de operación yape',
        'operation_number_4' => 'número de operación transferencia',
        'password' => 'contraseña',
        'payment_date' => 'fecha de pago',
        'payment_days' => 'días para pago',
        ...
        'store' => 'almacen',
        'subaccount_id' => 'subcuenta',
        'title' => 'título',
        'type' => 'tipo',
        'unit_price' => 'precio unitario',
        'usable_loss' => 'merma utilizable',
        'user' => 'usuario',
        'voucher' => 'comprobante',
